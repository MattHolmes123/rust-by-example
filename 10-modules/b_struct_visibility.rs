...
mod my {
    ...
    // A public struct with a private field to generic type `T`
    #[allow(dead_code)]
    ...
    impl<T> ClosedBox<T> {
        ...
        // TODO workout how to do this - its not in the correct place move outside this impl
        // pub fn what_is_inside(&self) {
